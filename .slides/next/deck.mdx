...
1. Om Variant
2. React
3. CSR, SSR, SSG, Rehydrering
4. Pizza
5. Next.js
6. Case (CSR til Next.js)
...
```html 12:25 file=./example/counter.html
...
```jsx 3:14 file=./example/Counter.js
...
- Pre-rendering, SSR og SSG
- Typescript
- Innebygd API for Serverless funksjoner
- Scaffolding med ´npm create-next-app´
...
```diff 1[33:36] subtitle="http.IncomingMessage, data fra brukeren"

```

```diff 1[39:42] subtitle="http.ServerResponse, response objekt til brukeren"
